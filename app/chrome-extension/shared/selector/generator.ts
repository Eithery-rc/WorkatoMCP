/**
 * Selector Generator — generates multiple candidate selectors for a DOM element.
 */
...
/**
 * CSS string escaping — uses native CSS.escape when available; otherwise falls back to a spec-inspired polyfill.
 */
