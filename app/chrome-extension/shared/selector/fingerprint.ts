/**
 * Element fingerprint generation and verification.
 *
 * Fingerprints are used for fuzzy element matching in scenarios like:
 * - Verifying the element found by a selector is the intended one
 * - Element recovery after HMR
 * - Avoiding false matches when the same selector resolves to different elements
 */
 ...
 * - class and text are not required (used for similarity scoring)
 *
 * @example
 * ```ts
 ...
 * Uses a similarity threshold (default 0.7).
 */
