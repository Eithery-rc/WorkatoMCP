...
/**
 * Create a test node definition — a simple node that supports succeed/fail/delay.
 */
...
/**
 * Create a V3 E2E test harness — assembles a complete V3 runtime for integration testing.
 */
