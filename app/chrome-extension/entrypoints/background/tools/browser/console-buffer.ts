...
/**
 * ConsoleBuffer — persistent console-log rolling buffer manager.
 *
 * Maintains a rolling buffer per tab that continuously collects console events.
 * The buffer is automatically cleared when the tab navigates to a new hostname
 * to prevent logs from different sites from mixing.
 */
...
/**
 * Extract safe preview data from a CDP RemoteObject, discarding objectId to prevent memory leaks.
 */
...
class ConsoleBuffer {
  ...
  /**
   * Returns true if buffer-mode capture is active for the given tab.
   */
  ...
  /**
   * Ensures buffer capture is running for the given tab.
   */
  ...
  /**
   * Clears the buffer for the given tab.
   */
  clear(
    tabId: number,
  ...
  /**
   * Reads buffered content for the given tab.
   */
  ...
  private handleTabUpdated(
    ...
    if (typeof nextUrl === 'string') {
      ...
      // Clear buffer on hostname change.
