/**
 * @fileoverview Record-Replay V3 public API entry point — re-exports all public types and interfaces.
 */
...
/**
 * Create a complete StoragePort implementation backed by IndexedDB.
 */
