...
/**
 * Convert a V2 Flow to V3 format for RPC saves.
 * @param flowV2 V2 Flow from the Builder store.
 * @returns V3 Flow and any conversion warnings.
 ...
 * @param flowV3 V3 Flow received from the RPC layer.
 * @returns V2 Flow and any conversion warnings.
 * @throws When conversion fails.
 */
...
/**
 * Returns true if `value` is a V3 Flow.
 * Used to identify JSON format on import.
 */
...
/**
 * Returns true if `value` is a V2 Flow.
 * Used to identify JSON format on import.
 */
 ...
 * Supports a single Flow object, an array of Flows, or `{ flows: Flow[] }`.
 */
