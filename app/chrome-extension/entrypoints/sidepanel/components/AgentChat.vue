...
import type { AgentStoredMessage, AgentMessage, CodexReasoningEffort } from 'workatomcp-shared';
...
import type { OpenProjectTarget } from 'workatomcp-shared';
...
const currentManagementInfo = ref<import('workatomcp-shared').AgentManagementInfo | null>(null);
